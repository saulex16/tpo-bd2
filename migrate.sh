...
psql -h localhost -U postgres -W password -d postgres -c "
...
mongoimport --db facturacion --collection clientes --file clientes.json --type=json
mongoimport --db facturacion --collection productos --file productos.json --type=json
mongoimport --db facturacion --collection facturas --file facturas.json --type=json
